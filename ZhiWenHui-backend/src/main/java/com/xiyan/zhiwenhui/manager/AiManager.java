package com.xiyan.zhiwenhui.manager;
...
//            throw new BusinessException(ErrorCode.SYSTEM_ERROR, "AI 的 Token 已用完");
            throw new BusinessException(ErrorCode.SYSTEM_ERROR, "您的账户可能已欠费，请充值后重试");
        }
    }
